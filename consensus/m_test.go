...
// newRsvp; For testing convenience
...
// newRsvpFrom; For testing convenience
...
// newInvite; For testing convenience
func newInvite(crnd int64) *msg {
	return &msg{Cmd: invite, Crnd: &crnd}
}

// newInviteSeqn1; For testing convenience
